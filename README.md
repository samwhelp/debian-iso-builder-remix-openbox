...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-remix-openbox/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-remix-openbox/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-remix-openbox/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-remix-openbox](https://github.com/samwhelp/debian-iso-builder-remix-openbox)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-remix-openbox.git
```


> change dir to `debian-iso-builder-remix-openbox`

``` sh
cd debian-iso-builder-remix-openbox
```
...
> change dir to `~/work/debian-iso-builder-remix-openbox/iso-profile`

``` sh
cd ~/work/debian-iso-builder-remix-openbox/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-remix-openbox/iso-profile/dist`
